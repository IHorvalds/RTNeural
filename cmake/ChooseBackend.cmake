...
option(RTNEURAL_RANGES "Use Ranges library for vector operations" OFF)
...
elseif(RTNEURAL_RANGES)
    message(STATUS "RTNeural -- Using Range-v3 library")
    target_compile_definitions(RTNeural PUBLIC RTNEURAL_USE_RANGES=1)
    target_include_directories(RTNeural PUBLIC modules/range-v3/include)
else()
